...
def fit_line(points):
    ...
    # REPLACE THE FOLLOWING WITH YOUR CODE
    #
    if((points[0][0] == points[1][0]) and (points[0][1] == points[1][1])): # same point
        print("error, same point")
    elif (points[0][0] == points[1][0]): # same x, vertical line
        print("error, vertical line")
    elif (points[0][1] == points[1][1]): # same y, horizontal line
...
##############################################################################
#test
points = [[3,2],[7,-4]] # normal
# points = [[3,2],[3,-4]] # vertical
# points = [[3,2],[7,2]] # horizontal
m,c = fit_line(points)

print(point_to_line_dist(-2,7,6,4))
